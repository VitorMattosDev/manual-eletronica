...
% --- Preâmbulo padrão das figuras do Manual de Eletrônica (centralizado aqui).
...
% --- Manual de Eletronica: esquematicos, cronogramas e portas logicas. ---
% --- circuitikz TEM de vir depois de pgfplots. ---
\usepackage{circuitikz}
\usepackage{tikz-timing}
\usetikzlibrary{circuits.logic.US}
\ctikzset{logic ports=ieee, resistors/scale=0.8, capacitors/scale=0.8}
% Estilo unico para diagramas de portas logicas (circuits.logic.US).
% Aplicar na tikzpicture: \begin{tikzpicture}[logica]
\tikzset{
  logica/.style={
    circuit logic US,
