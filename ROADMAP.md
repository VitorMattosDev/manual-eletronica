...
- [ ] 007 — Esquemáticos: como ler, como desenhar, como não se perder — `capitulos/007-esquematicos-como-ler-como-desenhar-como-nao-se.qmd`


### Volume 2 — Corrente Contínua: Leis Fundamentais

- [ ] 008 — Carga, corrente e o modelo de condução — `capitulos/008-carga-corrente-e-o-modelo-de-conducao.qmd`
- [ ] 009 — Tensão, potencial e referência (terra) — `capitulos/009-tensao-potencial-e-referencia-terra.qmd`
...
- [ ] 015 — Análise nodal — `capitulos/015-analise-nodal.qmd`
...
- [ ] 021 — Campo elétrico e capacitância — `capitulos/021-campo-eletrico-e-capacitancia.qmd`
- [ ] 022 — O capacitor real: tipos, ESR e tensão de trabalho — `capitulos/022-o-capacitor-real-tipos-esr-e-tensao-de-trabalho.qmd`
...
- [ ] 039 — Sinais periódicos, forma de onda e ciclo de trabalho — `capitulos/039-sinais-periodicos-forma-de-onda-e-ciclo-de-trabalho.qmd`
...
- [ ] 046 — Semicondutores, dopagem e a junção PN — `capitulos/046-semicondutores-dopagem-e-a-juncao-pn.qmd`
- [ ] 047 — O diodo real: curva, queda direta e modelos — `capitulos/047-o-diodo-real-curva-queda-direta-e-modelos.qmd`
- [ ] 048 — Retificadores de meia onda e de onda completa — `capitulos/048-retificadores-de-meia-onda-e-de-onda-completa.qmd`
